...
delete from fnbl_sync_source_type where id='galContactSyncSource';
...
insert into fnbl_sync_source_type(id, description, class, admin_class)
values('galContactSyncSource','GALContactSyncSource','ru.korusconsulting.connector.funambol.GALContactSyncSource','ru.korusconsulting.connector.config.ContactSyncSourceConfigPanel');
...
insert into fnbl_connector_source_type(connector, sourcetype)
values('zimbra','galContactSyncSource');
